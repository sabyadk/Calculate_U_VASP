...
def create_folder(LDAUL,LDAUJ,LDAUU,LMAXMIX,LDAUPRINT,alpha,j,natoms,NPAR,NSIM):
   ...
   from i_o import ISMEAR,SIGMA,ISPIN,EDIFF,LWAVE,ICHARG,ISYM,ENCUT,LREAL,NELM,AMIX,BMIX,AMIX_MAG,BMIX_MAG,LORBIT,LDAU,LDAUTYPE 
   ...
   ICHARG=11
   gen_INCAR(ISMEAR,SIGMA,ISPIN,EDIFF,LWAVE,ICHARG,ISYM,ENCUT,LREAL,NELM,NSIM,NPAR,AMIX,BMIX,AMIX_MAG,BMIX_MAG,LORBIT,LDAU,LDAUU,LDAUJ,LDAUL,LDAUTYPE,LDAUPRINT,LMAXMIX,natoms) 
...
def create_scf0(natoms,ntrans,mat,NPAR,NSIM):   
   ...
   from i_o import ISMEAR,SIGMA,ISPIN,EDIFF,LWAVE,ICHARG,ISYM,ENCUT,LREAL,NELM,AMIX,BMIX,AMIX_MAG,BMIX_MAG,LORBIT,LDAU,LDAUTYPE,LDAUPRINT,LMAXMIX
   from write_INCAR import *
   ...
   gen_INCAR(ISMEAR,SIGMA,ISPIN,EDIFF,LWAVE,ICHARG,ISYM,ENCUT,LREAL,NELM,NSIM,NPAR,AMIX,BMIX,AMIX_MAG,BMIX_MAG,LORBIT,LDAU,LDAUU,LDAUJ,LDAUL,LDAUTYPE,LDAUPRINT,LMAXMIX,natoms,name='INCAR_scf0')
